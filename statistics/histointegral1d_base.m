%% HISTOINTEGRAL1D_BASE - Integral histogram of an image.
% 
%% Description
...
%
%% Syntax
%     IH = HISTOINTEGRAL1D_BASE(I, nbin, bound);
% 
%% Remark
...
function [IH, I] = histointegral1d_base(I, nbin, bound)
...
if imax==imin,  
    error('histointegral1d_base:inputerror', 'constant image - nothing to do');
elseif nbin==0
...
end % end of histointegral1d_base
