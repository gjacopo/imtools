...
%
%% Description
% Given two (possibly reduced) spectra (e.g. singularity spectra representing
% fractal dimensions), quantify the degree of mutual closeness following the
% approach of [PTP09].
% 
%% Algorithm
% The mutual closeness of the spectra $D_1(h)$ and $D_2(h)$ with associated
% uncertainties $b_1(h)$ and $b_2(h)$ is expressed by the Eq.(7) of [PTP09]
% as:
%
% $$
...
%
%% Inputs
% *|h1, D1|* : couple of estimation, ie. the spectrum |D1| of a (set of) 
%     signal(s) is estimated over a set of values |h1|.
%
...
%
%% References
% [TPG06]  A. Turiel, C. Pérez-Vicente and J. Grazzini: "Numerical methods 
...
%      <http://www.sciencedirect.com/science/article/pii/S0378437109000880>
%
%% See also
% Related:
...
%%
% define the weighted average difference between the two reduced spectra as
% the minimum of the two possible directed weighted average differences
