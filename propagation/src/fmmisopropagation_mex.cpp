/*=================================================================
% fmmisopropagation_mex - perform a Fast Marching front propagation.
%
%   [D,S,Q] = fmmisopropagation_mex(W,start_points,end_points,nb_iter_max,H,L,values);
%
...
#include <graph.h>
#include <fmmisopropagation_2d.h>
