%% COMPARECOLS - Compare columns of a matrix.
%
%% Description
...
function R = comparecols(A,varargin)

%%
% parsing the parameters

if ~isnumeric(A)
    error('comparecols:inputerror',...
        'a matrix is required in input'); 
end

p = createParser('COMPARECOLS');   % create an instance of the inputParser class.
